 ...
 */
final class Version20230315201142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_in_list ADD id_shopping_list_id INT NOT NULL, ADD unity_price DOUBLE PRECISION NOT NULL, DROP id_shopping_list, DROP id_article');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_in_list ADD id_article INT NOT NULL, DROP unity_price, CHANGE id_shopping_list_id id_shopping_list INT NOT NULL');
